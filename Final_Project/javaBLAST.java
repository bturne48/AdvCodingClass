...
public class javaBLAST {
    ...
    // Coefficient C(n, k) 
     ...
     public void parseBlast(File blastResults, File illuminaBreakpoints){
          // read in blast results and illumina breakpoint
          System.out.println("UPDATE: START Reading in Blast Results");
          HashMap<Integer, ArrayList<String>> blastHash = TextFiles.readBlastResults(blastResults);
          System.out.println("UPDATE: DONE Reading in Blast Results\nUPDATE: START Read in Illumina Results");
          ArrayList<String> illumBPs = TextFiles.readIlluminaBPs(illuminaBreakpoints);
     ...
     public void makeSFS(File observedHaps, File sampledHaps, File confirmedVariants, Integer resampleSize){
          ...
          ArrayList<String> confVariants = TextFiles.readIlluminaBPs(confirmedVariants);
          ...
          for (String mut: obsvHaps) {
               ...
               // check if the variant was confirmed in part 2:
               if (!confVariants.contains(String.join(" ", mutBps))){
                    continue;
               };
          ...
          for (Float s: alleleFreqList) System.out.println(s);
    }
     ...
     public static void main(String[] args) throws Exception {
          ...
          //TODO: make try catch
          Integer whichPart = Integer.parseInt(args[0]);
          ...
          // PART 1: run the blast, otherwise specify where the files will be
          if (whichPart==1) {
               String dyakRef = "/Users/brando/Documents/GitHub/AdvCodingClass/Final_Project/DyakRef/dyakRef.fasta";
               jb.runBlast("/usr/local/ncbi/blast/bin/blastn", dyakRef, ccsFiles, "6");
          }

          // PART 2: parse blast results, output illumina breakpoints that can be confirmed
          if (whichPart == 2) {
               File inBlast = new File("/Users/brando/Documents/GitHub/AdvCodingClass/Final_Project/BLAST_Results/ST_1_16.blast");
               File inIllum = new File("/Users/brando/Documents/GitHub/AdvCodingClass/Final_Project/Input/clusteredVariants.txt");
               jb.parseBlast(inBlast, inIllum);
          }

          //PART 3: Calculate allele frequency
          if (whichPart == 3) {
               jb.makeSFS(new File("/Users/brando/Documents/GitHub/AdvCodingClass/Final_Project/Input/clusteredVariants.txt"), 
                         new File("/Users/brando/Documents/GitHub/AdvCodingClass/Final_Project/Input/sampledHaps.txt"),
                         new File("/Users/brando/Documents/GitHub/AdvCodingClass/Final_Project/Part2_Results/part2_results.txt"),
                         15);
          }
    }
}